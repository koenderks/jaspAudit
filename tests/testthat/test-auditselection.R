...
test_that("<b>Table 2.</b> Information about Monetary Interval Selection results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      3500, 1403220.82, 200, 200, 0.0750042890612185, "Total", 105247.58,
      0, 0, 0, 0, 0, "Top stratum", 0, 3500, 1403220.82, 200, 200,
      0.0750042890612185, "Bottom stratum", 105247.58
    )
  )
})
...
test_that("<b>Table 1.</b> Selection Summary results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(200, 0.0750042890612185, 200, 105247.58)
  )
})
...
test_that("<b>Table 2.</b> Selected Items results match", {
  ...
  jaspTools::expect_equal_tables(
    ...
    list(
      ...
      27583, 2512, 1, 105.15, 40057, 3472, 2, 318.8, 63696, 1331,
      ...
      57674, 1728, 1, 349.28, 96911, 652, 1, 652.39, 57115, 2896,
      ...
      27002, 2279, 1, 408.25, 71277, 904, 2, 294.71, 65816, 1675,
      ...
      1, 788, 35955, 3123, 1, 98.42, 90807, 3026, 2, 595.88, 95475,
      ...
      362, 1, 350.91, 95723, 1562, 2, 242.12, 91121, 2241, 1, 459.71,
      ...
      1, 352.75, 67389, 125, 1, 283.38, 35996, 2250, 1, 153.27, 52977,
      ...
      92541, 634, 1, 244.31, 60750, 1854, 1, 247.16, 92751, 264, 1,
      ...
      3246, 1, 228.68, 47424, 992, 1, 469.18, 7017, 2068, 1, 373.5,
...
test_that("<b>Table 1.</b> Selection Summary results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(200, 0.0571428571428571, 200)
  )
})
...
test_that("<b>Table 1.</b> Selection Summary results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(32, 0.403527293357342, 40, 54531.3333333333)
  )
})
